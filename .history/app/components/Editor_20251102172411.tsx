...
export default function Editor() {
  ...
  // Update chat history whenever messages change for the current component
  useEffect(() => {
    ...
    const timeoutId = setTimeout(updateChatHistory, 500);
                                            ...
                                            if (rec) {
                                              ...
                                              if (rec.chat_history && rec.chat_history.trim() !== '') {
                                                try {
                                                  ...
                                                  const trimmed = rec.chat_history.trim();
                                                  if (trimmed === 'undefined' || trimmed === 'null' || !trimmed.startsWith('[')) {
                                                    setMessages([]);
                                                    processedMessageIds.current.clear();
                                                  } else {
                                                    const parsedMessages = JSON.parse(trimmed);
